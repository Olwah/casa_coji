...
// DOM Strings
var navClosed = document.getElementById('nav-closed');
...
},{}],"rooms.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.expandRoom = void 0;

// DOM STRINGS
var expandRoom = function expandRoom() {
  var roomsItemInfo = document.getElementsByClassName('rooms__item-info');
  var roomsItemTitle = document.getElementsByClassName('rooms__item-title');
  var roomsItemPrice = document.getElementsByClassName('rooms__item-price');
  var expandIcons = document.getElementsByClassName('rooms__expand');
  ...
  var _loop = function _loop(i) {
    roomsItemInfo[i].addEventListener('click', function () {
      ...
      if (content.style.maxHeight) {
        ...
        [expandIcons[i], roomsItemTitle[i], roomsItemPrice[i]].forEach(function (el) {
  ...
  for (var i = 0; i < roomsItemInfo.length; i++) {
    _loop(i);
  }
};

exports.expandRoom = expandRoom;
},{}],"coursesActivities.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.expandActivities = void 0;

var expandActivities = function expandActivities(activityTypeIcon, activityItem) {
...
exports.expandActivities = expandActivities;
...
var _coursesActivities = require("./coursesActivities");
...
[navBtn, navClose].forEach(function (el) {
  return el.addEventListener('click', _navigation.toggleNav);
}); // HERO SLIDER MOBILE

document.addEventListener('DOMContentLoaded', function () {
  new _splide.default('#hero-slider', {
    cover: true,
    type: 'fade',
    perPage: 1,
    gap: 0,
    ...
    rewind: true,
    classes: {
      pagination: 'splide__pagination home__overview-pagination',
      // container
...
document.addEventListener('DOMContentLoaded', function () {
  var categoryNavSlider = new _splide.default('#foodNav-slider', {
    fixedWidth: 100,
    height: 60,
    gap: 10,
    cover: true,
  ...
  var categorySlider = new _splide.default('#food-slider', {
    type: 'fade',
    //heightRatio: 0.5,
    fixedHeight: '50vh',
    pagination: false,
...
var roomExpand = document.querySelector('.rooms__expand');
var roomExpands = document.querySelectorAll('.rooms__expand');
var roomGallery = document.querySelector('.rooms__gallery');
var roomGalleries = document.getElementsByClassName('.rooms__gallery');

if (roomExpand) {
  roomExpands.forEach(function (el) {
    el.addEventListener('click', _rooms.expandRoom);
  });
}
/*
if (roomGallery) {
...
var activitiesType = document.querySelector('.activities__type');
var activitiesTypes = document.querySelectorAll('.activities__type');

if (activitiesType) {
  activitiesTypes.forEach(function (el) {
    el.addEventListener('click', function (e) {
      if (e.target.matches('.activities__type, .activities__type *')) {
        var activityTypeIcon = e.target.closest('.activities__type').lastElementChild.lastElementChild;
        var activityItem = e.target.closest('.activities__type').nextElementSibling;
        (0, _coursesActivities.expandActivities)(activityTypeIcon, activityItem);
      }
    });
  });
}
},{"@splidejs/splide":"../../node_modules/@splidejs/splide/dist/js/splide.esm.js","./navigation":"navigation.js","./rooms":"rooms.js","./coursesActivities":"coursesActivities.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
